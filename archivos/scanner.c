...
{LEYENDO_CONS, LEYENDO_ERROR, LEYENDO_ERROR, LEIDO_CONS, LEIDO_CONS},
{LEYENDO_ID, LEYENDO_ID, LEYENDO_ERROR, LEIDO_ID, LEIDO_ID},
{LEYENDO_ERROR, LEYENDO_ERROR, LEYENDO_ERROR, LEIDO_ERROR, LEIDO_ERROR}
};
